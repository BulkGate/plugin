...
class SettingsDatabaseTest extends TestCase
{
	...
	public function testCreateTable(): void
	{
		...
		$connection->shouldReceive('execute')->with('ALTER TABLE `prefix_bulkgate_module` CHANGE `type` `type` varchar(50) COLLATE \'utf8_general_ci\' NULL DEFAULT \'string\' AFTER `key`, CHANGE `synchronize_flag` `synchronize_flag` varchar(50) COLLATE \'utf8_general_ci\' NOT NULL DEFAULT \'none\' AFTER `order`, ENGINE=\'InnoDB\';')->once();
